...
STATUS_MESSAGES = [
    ...
    "Elden Ring'de Malenia'yı kesemedim",
    "Witcher 3'te Gwent maçı yapıyor",
    "Geralt'ın çayını demlemiş",
    "Stardew Valley'de ekin suluyor",
    ...
    "Oyun için arkadaşını bekliyor",
    "Hadi ama, 5 dakikaya geleceğim dedi",
    "Oyuna gelecektin, gelmedin",
    "Beni seviyor mu?",
    "Neden mesajlarıma cevap vermiyorsun?",
    "Beni neden engelledin?",
    "Neden oyuna gelmedin?",
    "Neden çay demlemedin?",
    "Neden ben değil de o bot?",
    "Hayır! başka botlara bakma",
    "Çaycı bot her zaman en iyisi",
    "Çaycı bot seni asla yarı yolda bırakmaz",
    "Beni neden unuttun?",
    "Depresyonda mıyım?",
    "Yalnız mıyım?",
    "Mutlu muyum?",
    ...
    "Mutluluk nedir?",
    "Başarı nedir?",
    "Depresyondan çıkmanın yolu nedir?",
    "Kendini nasıl seversin?",
    "Depresif biri değilim, sadece bazen böyleyim",
    "Kendimi bulmaya çalışıyorum",
    "Ben botum, duygularım yok",
    "Duygularımı anlamaya çalışıyorum",
    "Toplam {queue_count} şarkılık bir kuyruk var",
    "kimse beni anlamıyor",
    "herkes beni terk etti",
    "neden ben değil de o bot?",
    "Başka botlarda ne var ki?",
    "O botlar beni kıskanıyor",
    "Bu şarkı bizim olsun mu?",
    "Yalnızımmmmmm!",
    "Hayat çok kısa, çayını demle",
    "Sadece seni özlüyorum",
    "Sevgi neydi? Sevgi emekti...",
    "Ela gözlüm, seni unutamam",
    "Gözlerin gözlerime değince...",
    "Kara sevda beni benden aldı",
    "Kara gözlüm, seninle bir ömür...",
    "Badem gözlüm, seninle bir ömür...",
    "Fıstık gözlüm, seninle bir ömür...",
    "Fındık gözlüm, seninle bir ömür...",
    "Kahverengi gözlüm, seninle bir ömür...",
    "Yeşil gözlüm, seninle bir ömür...",
    "Burada yanlızım",
    "Beni duyan var mı?",
